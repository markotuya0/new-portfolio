...
import proj2 from "../../public/images/projects/proxy.png";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="My Project portfolio" />
      </Head>
      ...
      <main className={`mb-16  flex w-full flex-col items-center justify-center dark:text-light`}>
        <Layout className="pt-16">
          <AnimatedText
            text="Showcasing My Latest Projects 🚀"
            className="mb-16 !text-5xl !leading-tight lg:!text-4xl sm:mb-8 sm:!text-3xl xs:!text-2xl"
          />
