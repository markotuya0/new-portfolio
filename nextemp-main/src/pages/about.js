    ...
    <>
      ...
      <main className={`flex  w-full flex-col items-center justify-center dark:text-light`}>
        <Layout className="pt-16">
          <AnimatedText
            text="Let Code Drive Your Purpose 💻"
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            md:col-span-8">
              ...
              <p className="font-medium ">
                Hi, I'm Mark! I’m a Full-Stack Developer with over 4 years of experience building
                innovative and user-friendly web applications. Throughout my career, I’ve worked
              ...
              <p className="my-4 font-medium">
                P.S. I’m a big fan of gaming and just a digital wanderer shrouded in mystery 🕵️‍♂️.{" "}
              </p>
            </div>
            <div
